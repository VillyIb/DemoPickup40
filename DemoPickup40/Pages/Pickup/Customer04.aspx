<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="Customer04.aspx.cs" Inherits="DemoPickup40.Pages.Pickup.Customer04" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <link href="Customer04.css" rel="stylesheet" />
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:UpdatePanel ID="XuUpdatePanel1" runat="server">
        ...
        <ContentTemplate>
            ...
            <asp:GridView
                ID="XuCustomer04Pickup"
                runat="server"
                AutoGenerateColumns="False"
                ShowHeaderWhenEmpty="True"
                CssClass=""
                OnRowCommand="XuGridCustomer04Pickup_RowCommand">

                <HeaderStyle CssClass="XuCustomer04PickupHeader" />
                <RowStyle CssClass="XuCustomer04PickupRow" />
                    ...
                    <asp:TemplateField HeaderText="XuStatus">
                        ...
                        <ItemTemplate>
                            ...
                            <asp:LinkButton
                                ...
                                CommandName="XcCmd01"
                                CommandArgument='<%# Eval("PickupStatusCustomer") + "." + Eval("Id") %>'>
                                <span 
                        ...
                        <ItemTemplate>
                            <asp:LinkButton ID="XuMoveItem" CommandArgument='<%# Eval("Id") %>' runat="server" CausesValidation="false" CommandName="XcCmd02" ToolTip='<%# GetLocalResourceObject("XuMoveItem.ToolTip") %>   '>
                                <span 
                                    ...
                                    title='<%# GetLocalResourceObject("XuMove-Icon_StatusCode-" + Eval("PickupStatusCustomer") + ".ToolTip") %>' 
                                    />
                            </asp:LinkButton>
