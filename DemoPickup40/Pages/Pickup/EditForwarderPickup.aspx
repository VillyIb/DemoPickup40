<%@ Page
    ...
    CodeBehind="EditForwarderPickup.aspx.cs"
    Inherits="DemoPickup40.Pages.Pickup.EditForwarderPickup" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="css-table">
        ...
        <div class="css-tr">
            ...
            <span class="css-td col2">
                <asp:TextBox ID="XuName" runat="server"></asp:TextBox></span>
        ...
        <div class="css-tr">
            ...
            <span class="css-td col2">
                <asp:TextBox ID="XuStreet1" runat="server"></asp:TextBox></span>
            <div class="css-td col3">&nbsp;</div>
        </div>
        ...
        <div class="css-tr">
            ...
            <span class="css-td col2">
                <asp:TextBox ID="XuStreet2" runat="server"></asp:TextBox></span>
            <div class="css-td col3">&nbsp;</div>
        </div>
        ...
        <div class="css-tr">
            ...
            <span class="css-td col2">
                <asp:TextBox ID="XuState" runat="server"></asp:TextBox></span>
            <div class="css-td col3">&nbsp;</div>
        </div>
        ...
        <div class="css-tr">
            ...
            <span class="css-td col2">
                <asp:TextBox ID="XuCountryCode" runat="server"></asp:TextBox></span>
            <div class="css-td col3">&nbsp;</div>
        </div>
        ...
        <div class="css-tr">
            ...
            <span class="css-td col2">
                <asp:TextBox ID="XuZip" runat="server"></asp:TextBox></span>
            <div class="css-td col3">&nbsp;</div>
        </div>
        ...
        <div class="css-tr">
            ...
            <span class="css-td col2">
                <asp:TextBox ID="XuAttention" runat="server"></asp:TextBox></span>
            <div class="css-td col3">&nbsp;</div>
        </div>
        ...
        <div class="css-tr">
            ...
            <span class="css-td col2">
                <asp:TextBox ID="XuEmail" runat="server"></asp:TextBox></span>
            <div class="css-td col3">&nbsp;</div>
        </div>
        ...
        <div class="css-tr">
            ...
            <span class="css-td col2">
                <asp:TextBox ID="XuPhone" runat="server"></asp:TextBox></span>
            <div class="css-td col3">&nbsp;</div>
        </div>
        ...
        <div class="css-tr">
            ...
            <span class="css-td col2">
                <asp:TextBox ID="XuNote" runat="server"></asp:TextBox></span>
            <div class="css-td col3">&nbsp;</div>
        </div>
        ...
        <div class="css-tr">
            ...
            <span class="css-td col2">
                <asp:TextBox ID="XuPickupDate" runat="server"></asp:TextBox></span>
            <div class="css-td col3">&nbsp;</div>
        </div>
        ...
        <div class="css-tr">
            ...
            <span class="css-td col2">
                <asp:TextBox ID="XuTimeReady" runat="server"></asp:TextBox></span>
            <span class="css-td col3">
                <asp:Button ID="XuTimeReadyCalculated" runat="server" Text="12:00" OnClick="XuTimeReadyCalculated_Click" /></span>
        </div>

        <div class="css-tr">
            <asp:Label ID="Label13" class="css-td col1" runat="server" Text="TimeClose"></asp:Label>
            <span class="css-td col2">
                <asp:TextBox ID="XuTimeClose" runat="server"></asp:TextBox></span>
            <span class="css-td col3">
                <asp:Button ID="XuTimeCloseCalculated" runat="server" Text="15:00" OnClick="XuTimeCloseCalculated_Click" /></span>
        </div>

        <div class="css-tr">
            <asp:Label ID="Label15" CssClass="css-td col1" runat="server" Text="Pickup Operator"></asp:Label>
            <span class="css-td col2">
                <asp:DropDownList ID="XuPickupOperator" runat="server"></asp:DropDownList></span>
            <div class="css-td col3">&nbsp;</div>
        ...
        <div class="css-tr">
            ...
            <span class="css-td col2">
                <asp:DropDownList ID="XuPickupStatus" runat="server"></asp:DropDownList></span>
            <div class="css-td col3">&nbsp;</div>
        </div>
